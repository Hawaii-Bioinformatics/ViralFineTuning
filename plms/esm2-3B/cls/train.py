...
model = EsmForSequenceClassification.from_pretrained(model_checkpoint, num_labels=len(labels), id2label=id2label, label2id=label2id)
...
training_args = TrainingArguments(
    output_dir="./results-esm-cls-strat",
...
model.base_model.save_pretrained(save_directory = "./results-esm-cls-strat", safe_serialization = False)
